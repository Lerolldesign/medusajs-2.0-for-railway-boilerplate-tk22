...
export default function page() {
  return (
    <div className="flex gap-1 xl:gap-5 flex-col lg:flex-row w-[100vw] justify-center lg:justify-between xl:justify-center h-auto bg-browny noise ">
      <Link href="/services/illuminer-votre-interieur" className="">
        ...
        <div className="flex flex-col relative bottom-[50vh] w-[80vw] left-10 md:left-14 xl:left-3  md:bottom-[20vh] xl:bottom-[45vh] 2xl:bottom-[35vh] xl:w-[32vw]  items-center justify-center">
      ...
      <Link href="/services/enjoliver-vos-espaces" className="">
        ...
        <div className="flex flex-col relative bottom-[50vh] w-[80vw] left-10 md:left-14 xl:left-3  md:bottom-[20vh] xl:bottom-[45vh] 2xl:bottom-[38vh] xl:w-[32vw]  items-center justify-center">
      ...
      <Link href="/services/restaurer-vos-sieges" className="">
        ...
        <div className="flex flex-col relative bottom-[50vh] w-[80vw] left-10 md:left-14 xl:left-3  md:bottom-[20vh] xl:bottom-[30vh] xl:w-[32vw]  2xl:bottom-[32vh] items-center justify-center">
